...
class AuthController extends CI_Controller
{
  ...
  {
    if($this->session->has_userdata('SESS_MAP_USERID')) {
			redirect('dashboard');
		}
  ...
  {
		$this->session->unset_userdata("SESS_MAP_USERID");
		$this->session->unset_userdata("SESS_MAP_USERNAME");
		$this->session->unset_userdata("SESS_MAP_ROLEID");
