    ...
    <div class="container">
      <div class="row">
        <div class="col-12 mb-3">
          <a href="<?= base_url("pegawai/add") ?>" class="btn btn-primary float-right">TAMBAH DATA</a>
        </div>
        <div class="col-12">
          <table class="table table-print">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?= $data['jabatan'] ?></td>
                <td>
                  <a href="<?= base_url("pegawai/edit/") . $data['id'] ?>" class="badge badge-info badge-sm">Edit</a>
